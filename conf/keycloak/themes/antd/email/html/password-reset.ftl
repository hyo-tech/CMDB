      ...
      <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="padding:0 40px 16px;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#fff7e6; border-left:4px solid #faad14; border-radius:4px;">
              <tr>
                <td style="padding:12px 16px; font-family:${productFont}; font-size:13px; color:#d48806; line-height:1.6;">
