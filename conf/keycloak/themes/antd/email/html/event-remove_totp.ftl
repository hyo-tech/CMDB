  ...
  <tr>
    <td align="center">
      <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <!-- Header -->
        <tr>
          <td style="background-color:#faad14; padding:32px 40px; text-align:center;">
        ...
        <tr>
          <td style="padding:40px;">
            <p style="margin:0 0 8px; font-family:${productFont}; font-size:16px; color:#1f1f1f;">
              ${msg("eventRemoveTotpGreeting", user.firstName!user.username!"")}
            </p>
            <p style="margin:0 0 24px; font-family:${productFont}; font-size:14px; color:#666666; line-height:1.6;">
              ${msg("eventRemoveTotpBody", realmName)}
            </p>

            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:24px;">
              <tr>
                <td style="background-color:#fff7e6; border-left:4px solid #faad14; border-radius:4px; padding:16px 20px;">
                  <p style="margin:0; font-family:${productFont}; font-size:13px; color:#d48806; line-height:1.6;">
                    ${msg("eventRemoveTotpWarning")}
                  </p>
                </td>
              </tr>
            </table>
