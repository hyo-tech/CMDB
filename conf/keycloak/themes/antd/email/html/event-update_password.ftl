        ...
        <tr>
          <td style="padding:40px;">
            <p style="margin:0 0 8px; font-family:${productFont}; font-size:16px; color:#1f1f1f;">
              ${msg("eventUpdatePasswordGreeting", user.firstName!user.username!"")}
            </p>
            <p style="margin:0 0 24px; font-family:${productFont}; font-size:14px; color:#666666; line-height:1.6;">
              ${msg("eventUpdatePasswordBody", realmName)}
            </p>

            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:24px;">
              <tr>
                <td style="background-color:#f6ffed; border-left:4px solid #52c41a; border-radius:4px; padding:16px 20px;">
                  <p style="margin:0; font-family:${productFont}; font-size:13px; color:#389e0d; line-height:1.6;">
                    ${msg("eventUpdatePasswordSuccess")}
                  </p>
                </td>
              </tr>
            </table>

            <p style="margin:0 0 24px; font-family:${productFont}; font-size:13px; color:#999999; line-height:1.6;">
              ${msg("eventUpdatePasswordTip")}
            </p>
          </td>
        </tr>
